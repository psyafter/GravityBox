...
package com.ceco.v.gravitybox.tuner;
...
import com.ceco.v.gravitybox.GravityBoxActivity;
import com.ceco.v.gravitybox.R;
import com.ceco.v.gravitybox.SettingsManager;
import com.ceco.v.gravitybox.WorldReadablePrefs;
...
public class TunerMainActivity extends GravityBoxActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() == null || !getIntent().hasExtra(EXTRA_UUID_REGISTERED) ||
            ...
            // Premium force-enabled: treat as registered, never close on expired trial.
            uuidRegistered = true;
    ...
    public static boolean isTunerLocked(Context context) {
        // Premium force-enabled: Tuner is never locked regardless of trial/unlocker state.
        return false;
    }
