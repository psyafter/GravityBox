...
public class GravityBox implements IXposedHookZygoteInit, IXposedHookLoadPackage {
    ...
    private static final File prefsFileProt = new File("/data/user_de/0/com.ceco.v.gravitybox/shared_prefs/com.ceco.v.gravitybox_preferences.xml");
    private static final File qhPrefsFileProt = new File("/data/user_de/0/com.ceco.v.gravitybox/shared_prefs/quiet_hours.xml");
    private static final File uncPrefsFileProt = new File("/data/user_de/0/com.ceco.v.gravitybox/shared_prefs/ledcontrol.xml");
    private static final File tunerPrefsFileProt = new File("/data/user_de/0/com.ceco.v.gravitybox/shared_prefs/tuner.xml");
