...
import com.ceco.v.gravitybox.ledcontrol.LedMainActivity;
import com.ceco.v.gravitybox.ledcontrol.LedSettings;
import com.ceco.v.gravitybox.managers.SysUiBatteryInfoManager;
import com.ceco.v.gravitybox.preference.AppPickerPreference;
import com.ceco.v.gravitybox.preference.SeekBarPreference;
import com.ceco.v.gravitybox.quicksettings.TileOrderActivity;
import com.ceco.v.gravitybox.shortcuts.ShortcutActivity;
import com.ceco.v.gravitybox.tuner.TunerMainActivity;
import com.ceco.v.gravitybox.webserviceclient.RequestParams;
import com.ceco.v.gravitybox.webserviceclient.TransactionResult;
import com.ceco.v.gravitybox.webserviceclient.WebServiceClient;
import com.ceco.v.gravitybox.webserviceclient.TransactionResult.TransactionStatus;
import com.ceco.v.gravitybox.webserviceclient.WebServiceClient.WebServiceTaskListener;
...
//            PREF_KEY_HEADS_UP_SNOOZE_TIMER
    ...
    public static class PrefsFragment extends PreferenceFragment 
        ...
        private void setDefaultValues() {
            ...
            // Premium force-enabled: always unlock all features regardless of
            // UUID registration / unlocker / trial state.
            unrestrictFeatures();
        ...
        public void onSharedPreferenceChanged(SharedPreferences prefs, String key) {
            ...
            if (key.equals(PREF_KEY_BATTERY_STYLE)) {
                ...
                getActivity().getPackageManager().setComponentEnabledSetting(
                        new ComponentName(getActivity(), "com.ceco.v.gravitybox.GravityBoxSettingsAlias"),
